 ...
 *  - feature-graphic-en.png         (1024×500) — banner promocional Play Store
...
function featureGraphicSVG() {
  ...
  <g transform="translate(180, 145)">
    ...
    <text x="0" y="58" fill="${ACCENT}" font-family="-apple-system, sans-serif" font-size="22" font-weight="600" letter-spacing="2" text-transform="uppercase">TECH DASHBOARD</text>
  </g>

  <!-- Tagline e features -->
  <g transform="translate(180, 270)">
    <text x="0" y="0" fill="${TEXT_PRIMARY}" font-family="-apple-system, sans-serif" font-size="34" font-weight="700">Indoor grow, under control.</text>
    <text x="0" y="48" fill="${TEXT_SECONDARY}" font-family="-apple-system, sans-serif" font-size="20" font-weight="400">Tents, ciclos, calculadoras e sensores —</text>
...
function screenshot1HeroSVG() {
  ...
  <!-- Tagline -->
  <text x="540" y="900" text-anchor="middle" fill="${ACCENT}" font-family="-apple-system, sans-serif" font-size="36" font-weight="600" letter-spacing="6" text-transform="uppercase">TECH DASHBOARD</text>

  <!-- Description -->
  <text x="540" y="1020" text-anchor="middle" fill="${TEXT_SECONDARY}" font-family="-apple-system, sans-serif" font-size="42" font-weight="400">Indoor grow, under control.</text>
  <text x="540" y="1080" text-anchor="middle" fill="${TEXT_SECONDARY}" font-family="-apple-system, sans-serif" font-size="42" font-weight="400">No guesswork. No loss.</text>
  ...
  <g transform="translate(60, 1280)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="120" y="64" fill="${TEXT_PRIMARY}" font-size="32" font-weight="700">Tents</text>
      <text x="120" y="104" fill="${TEXT_SECONDARY}" font-size="22">Full cycles</text>
    ...
    <g transform="translate(495, 0)">
      ...
      <text x="120" y="64" fill="${TEXT_PRIMARY}" font-size="32" font-weight="700">Plants</text>
      <text x="120" y="104" fill="${TEXT_SECONDARY}" font-size="22">Photos + health</text>
      <text x="120" y="134" fill="${TEXT_SECONDARY}" font-size="22">Weekly logs</text>
    </g>
    <!-- Card 3: Calculators -->
    <g transform="translate(0, 220)">
      ...
      <text x="120" y="64" fill="${TEXT_PRIMARY}" font-size="32" font-weight="700">Calculators</text>
    ...
    <g transform="translate(495, 220)">
      ...
      <text x="120" y="64" fill="${TEXT_PRIMARY}" font-size="32" font-weight="700">Sensors</text>
      <text x="120" y="104" fill="${TEXT_SECONDARY}" font-size="22">SmartLife / Tuya</text>
      <text x="120" y="134" fill="${TEXT_SECONDARY}" font-size="22">Auto readings</text>
    </g>
  </g>
  ...
  <g transform="translate(60, 1800)">
    ...
    <text x="480" y="80" text-anchor="middle" fill="#000" font-family="-apple-system, sans-serif" font-size="42" font-weight="700">Start free</text>
  </g>

  <!-- Footer -->
  <text x="540" y="2280" text-anchor="middle" fill="${TEXT_TERTIARY}" font-size="26">1 tent free • No credit card</text>
</svg>`;
}

// ──────────────────────────────────────────────────────────────────────────
// Screenshot 2: Lista de Tents
// ──────────────────────────────────────────────────────────────────────────
...
function screenshot2TentsSVG() {
  ...
  <g transform="translate(60, 120)">
    <text x="0" y="60" fill="${ACCENT}" font-family="-apple-system, sans-serif" font-size="28" font-weight="700" letter-spacing="4" text-transform="uppercase">PANEL</text>
    <text x="0" y="160" fill="${TEXT_PRIMARY}" font-family="-apple-system, sans-serif" font-size="76" font-weight="800">Your tents</text>
    <text x="0" y="230" fill="${TEXT_SECONDARY}" font-family="-apple-system, sans-serif" font-size="32">Track every cycle in real time</text>
  </g>
  ...
  <g transform="translate(60, 480)">
    ...
    <text x="120" y="92" fill="${TEXT_PRIMARY}" font-size="42" font-weight="700">Main tent</text>
    <text x="120" y="138" fill="${ACCENT}" font-size="26" font-weight="600">Flowering · Week 4</text>
  ...
  <g transform="translate(60, 840)">
    ...
    <text x="120" y="92" fill="${TEXT_PRIMARY}" font-size="42" font-weight="700">Mother &amp; clones</text>
    <text x="120" y="138" fill="${PURPLE}" font-size="26" font-weight="600">Cloning · Week 2</text>
    <text x="120" y="182" fill="${TEXT_SECONDARY}" font-size="24">12 clones · 3 active mothers</text>
  </g>
  ...
  <g transform="translate(60, 1100)">
    ...
    <text x="120" y="92" fill="${TEXT_PRIMARY}" font-size="42" font-weight="700">Drying room</text>
    <text x="120" y="138" fill="${AMBER}" font-size="26" font-weight="600">Drying · Day 7 of 14</text>
    <text x="120" y="182" fill="${TEXT_SECONDARY}" font-size="24">RH 60% · 18°C constant</text>
  </g>

  <!-- Alerts section -->
  <g transform="translate(60, 1420)">
    <text x="0" y="60" fill="${TEXT_PRIMARY}" font-size="46" font-weight="700">Active alerts</text>
  </g>
  ...
  <g transform="translate(60, 1520)">
    ...
    <text x="100" y="62" fill="${TEXT_PRIMARY}" font-size="32" font-weight="600">pH below target</text>
    <text x="100" y="106" fill="${TEXT_SECONDARY}" font-size="24">Main tent · pH 5.3 (target 5.8-6.2)</text>
  </g>
  ...
  <g transform="translate(60, 1690)">
    ...
    <text x="100" y="62" fill="${TEXT_PRIMARY}" font-size="32" font-weight="600">Temp at limit</text>
    <text x="100" y="106" fill="${TEXT_SECONDARY}" font-size="24">Main tent · 28°C (max 27°C)</text>
  </g>

  <!-- Title pra screenshot -->
  <text x="540" y="2310" text-anchor="middle" fill="${ACCENT}" font-family="-apple-system, sans-serif" font-size="42" font-weight="700">All tents in one panel</text>
</svg>`;
}
...
function screenshot3PlantSVG() {
  ...
  <!-- Header -->
  <g transform="translate(60, 120)">
    <text x="0" y="60" fill="${PURPLE}" font-family="-apple-system, sans-serif" font-size="28" font-weight="700" letter-spacing="4" text-transform="uppercase">PLANT #3</text>
    <text x="0" y="160" fill="${TEXT_PRIMARY}" font-family="-apple-system, sans-serif" font-size="76" font-weight="800">Green Basil</text>
    <text x="0" y="220" fill="${TEXT_SECONDARY}" font-family="-apple-system, sans-serif" font-size="32">Main tent · Vegetative · Wk 3</text>
  </g>

  <!-- Stats grid -->
  <g transform="translate(60, 460)">
    <rect width="465" height="220" rx="24" fill="${CARD_BG}" stroke="${CARD_BORDER}" stroke-width="2"/>
    <text x="40" y="60" fill="${TEXT_TERTIARY}" font-size="24">HEIGHT</text>
    ...
    <text x="40" y="178" fill="${ACCENT}" font-size="22">+5cm this week</text>
  </g>

  <g transform="translate(555, 460)">
    <rect width="465" height="220" rx="24" fill="${CARD_BG}" stroke="${CARD_BORDER}" stroke-width="2"/>
    <text x="40" y="60" fill="${TEXT_TERTIARY}" font-size="24">HEALTH</text>
    <circle cx="80" cy="130" r="32" fill="${ACCENT}" opacity="0.2"/>
    <text x="80" y="142" text-anchor="middle" font-size="36">✓</text>
    <text x="140" y="130" fill="${TEXT_PRIMARY}" font-size="40" font-weight="700">Healthy</text>
    <text x="140" y="180" fill="${TEXT_SECONDARY}" font-size="22">No symptoms</text>
  </g>

  <!-- Timeline title -->
  <g transform="translate(60, 750)">
    <text x="0" y="60" fill="${TEXT_PRIMARY}" font-size="46" font-weight="700">History</text>
  </g>
  ...
  <g transform="translate(60, 880)">
    ...
    <text x="80" y="20" fill="${TEXT_PRIMARY}" font-size="30" font-weight="600">Photo added</text>
    <text x="80" y="60" fill="${TEXT_SECONDARY}" font-size="24">Today · 14:32</text>
...
function screenshot4CalculatorSVG() {
  ...
  <text x="540" y="2280" text-anchor="middle" fill="${SKY}" font-family="-apple-system, sans-serif" font-size="42" font-weight="700">Calculators técnicas precisas</text>
</svg>`;
}
...
async function main() {
  ...
  // Feature graphic
  await renderSVG(featureGraphicSVG(), path.join(OUT_DIR, "feature-graphic-en.png"), 1024, 500);
