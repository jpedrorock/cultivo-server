...
type PollInterval = 60 | 180 | 480 | 720 | 1440;

const REGION_LABELS: Record<Region, string> = {
  eu: 'Europa', us: 'América', cn: 'China', in: 'Índia',
};

// 5 opções simplificadas. Ordenadas do MAIS econômico (1x/dia) pro MENOS (1h).
...
// Removida opção 30min — era agressivo demais e queimava quota rápido.
